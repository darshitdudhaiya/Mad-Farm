          ...
          <div className="col-lg-6">
            <div className="d-flex align-items-center justify-content-center">
              <a href="index.html" className="navbar-brand ms-lg-5">
                <h2 className="m-0 display-4 text-primary">
                  Marvel Agro &{" "}
                  <span className="text-secondary">Dairy Farm</span>
                </h2>
              </a>
            </div>
          </div>
          ...
          <div className="navbar-nav mx-auto py-0">
            ...
            <div className="nav-item dropdown">
              ...
              <div className="dropdown-menu m-0">
                <Link to="/MilkProduct" className="dropdown-item">
                  Milk Product
                </Link>
                <Link to="/CowProduct" className="dropdown-item">
                  Cow Product
                </Link>
                <Link to="/FarmProduct" className="dropdown-item">
                  Farm Product
                </Link>
