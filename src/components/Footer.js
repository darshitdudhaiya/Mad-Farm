            ...
            <div className="col-lg-8 col-md-6">
              <div className="row gx-5">
                <div className="col-lg-4 col-md-12 pt-5 mb-5">
                  ...
                  <div className="d-flex mb-2">
                    ...
                    <p className="text-white mb-0">
                      "Banshi Farm", Nr. Shivalik Shine Party Plot, Lakhabaval
                    </p>
                  </div>
                  <div className="d-flex mb-2">
                ...
                <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                  ...
                  <div className="d-flex flex-column justify-content-start">
                    <Link className="text-white mb-2" to="/" onClick={scrollToTop}>
                      <i className="bi bi-arrow-right text-white me-2"></i>Home
                    </Link>
                    <Link className="text-white mb-2" to="/About" onClick={scrollToTop}>
                      <i className="bi bi-arrow-right text-white me-2"></i>About
                      Us
                    </Link>
                    <Link className="text-white mb-2" to="/Services" onClick={scrollToTop}>
                      <i className="bi bi-arrow-right text-white me-2"></i>Our
                      Services
                    </Link>
                    <Link className="text-white" to="/AllProduct" onClick={scrollToTop}>
                      <i className="bi bi-arrow-right text-white me-2"></i>Our
                      Product
                    </Link>
                    <Link className="text-white" to="/Gallery" onClick={scrollToTop}>
